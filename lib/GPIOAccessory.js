...
const SysFS = require('./sysfs-gpio.js');
const FS = require('fs');
...
class GPIOAccessory extends EventEmitter {
    ...
    constructor(log, accessory, wpi, onChar)
    {
        ...
        //Set state of Pull Up/Down Resistor
        switch(this.context.pull) {
            case "up":
                this.pullState = wpi.PUD_UP;
                break;
            case "down":
                this.pullState = wpi.PUD_DOWN;
                break;
            default:
                this.pullState = wpi.PUD_OFF;
                break;
        }

        wpi.pullUpDnControl(this.context.pin, this.pullState);
        ...
        switch(this.context.mode) {
            ...
            case "in":
                break;
            default:
                throw Error("Tried to create a GPIOAccessory where accessory mode is not in or out");
                break;
        }
    }
}
